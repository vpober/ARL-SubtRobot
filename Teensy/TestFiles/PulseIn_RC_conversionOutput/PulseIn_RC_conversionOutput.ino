//convert PulseIn for RC signals to velocity or switch output
//add switch and functions for ROS vs RC control
  //too much delay, switch performance inconsistent
#include<Kangaroo.h>
...
void loop() {
  ...
  if(S_begin > SWITCH_THRESHOLD && S_pulse < SWITCH_THRESHOLD){
    ...
    ROS_control();
    Serial.println("Ready to connect to ROS");
